...
% assign to numwords and batchsize the dimensions of input_batch
[numwords, batchsize] = size(input_batch);

% assign to vocab_size and numhid1 the dimensions of word_embedding_weights
[vocab_size, numhid1] = size(word_embedding_weights);

% assign to numhid2 the 2nd value output by size(embed_to_hid_weights) ie
% number of columns in embed_to_hid_weights
...
% exponents. Cool, but would still get an imprecision instead
